    ...
    <div className="grid md:grid-cols-[1fr_2fr] gap-8 px-16 py-10 mb-18">
      <div className="grid py-5 px-6 rounded-md shadow-md h-fit gap-3">
        <div className="flex gap-4 mb-3 items-center"> 
          <p className="rounded-full bg-red-700 text-white text-xl p-3"><FiPhoneCall /></p>
        ...
        <div className="flex gap-4 mb-3 items-center">
          <p className="rounded-full bg-red-700 text-white text-xl p-3"><FiMail /></p>
...
className="bg-[#f5f5f5] w-full min-h-[150px] p-4 mt-4 rounded border border-transparent outline-none focus:border-green-600 placeholder-gray-400 text-black font-semibold"          placeholder="Your Message"
        ...
        <div className="flex justify-end mt-18">
          <button className="bg-red-700 text-white py-3 px-8 rounded">Send Message</button>
        </div>
      </div>
    </div>
  )
