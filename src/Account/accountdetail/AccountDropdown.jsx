  ...
  return (
    <div className="flex flex-col gap-2 px-6 ">
      <div className="flex flex-col gap-2 ">
        <p onClick={() => setisOpen(1)} className=" font-medium text-text-primary cursor-pointer">Manage My Account </p>
        {isOpen === 1 && (
      ...
      <div className="grid  gap-2">
        <p onClick={() => setisOpen(2)} className="font-medium text-text-primary cursor-pointer"> My Orders</p>
        {isOpen === 2 && (
          <div className="flex flex-col gap-2 pl-4 cursor-pointer">
